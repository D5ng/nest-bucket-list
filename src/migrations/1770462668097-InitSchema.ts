...
export class InitSchema1770462668097 implements MigrationInterface {
  name = 'InitSchema1770462668097'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL DEFAULT '', "username" character varying(255) NOT NULL DEFAULT '', "password" character varying(255) NOT NULL DEFAULT '', "refresh_token" character varying(255), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
